...
const HomePage = () => {
	...
	return (
		<section >
			<div className="container mx-auto py-1 md:py-1 px-4 md:px-6">
        ...
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        ...
                        <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">bất ngờ</span>
                    </h2>
                    <p className="text-base text-gray-700"></p>
                    <div className="mt-10 flex flex-col items-center md:flex-row">
                        <Link to={'/pricing'}>
                        	<a  className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
	                           Xem ngay</a>
                        </Link>
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                     <img src="https://img.freepik.com/premium-vector/book-day-illustration-wallpaper-boy-reading-banner_94145-116.jpg"/>
                </div>
            </div>
        </div>
    </div> 
