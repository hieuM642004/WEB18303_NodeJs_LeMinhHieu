  ...
  const handleLogin = async (values, { setSubmitting }) => {
    try {
      ...
      if (response.status === 200) {
        ...
        localStorage.setItem('user', JSON.stringify([data._id,data.username, data.email]));
          ...
          {({ isSubmitting }) => (
            <Form className="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
              ...
              <p className="block mt-4 font-sans text-base antialiased font-normal leading-relaxed  text-gray-700">
                ...
                <Link to="/register">
                  <a className="font-medium text-sm text-gray-900">Quên mật khẩu?</a>
                </Link>
              </p>
              ...
              <p className="block mt-4 font-sans text-base antialiased font-normal leading-relaxed text-center text-gray-700">
                ...
                <Link to="/register">
                  <a className="font-medium text-gray-900">Đăng kí</a>
                </Link>
              </p>
            </Form>
          )}
